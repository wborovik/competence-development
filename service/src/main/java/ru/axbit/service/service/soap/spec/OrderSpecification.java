    ...
    public static Specification<WorkOrder> create(OrderCriteriaDTO criteriaDTO, PagingUtils.SortingOptions sort) {
        return (root, query, criteriaBuilder) -> {
            ...
            predicateBuilder
                    ...
                    .equals(root.get(WorkOrder.Fields.customer).get(AbstractEntity.Fields.id), criteriaDTO.getCustomerId())
                    .equals(root.get(WorkOrder.Fields.executor).get(AbstractEntity.Fields.id), criteriaDTO.getExecutorId())
