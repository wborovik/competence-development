...
public enum BusinessExceptionEnum {
    ...
    E006("006", "У заказа с идентификатором %s уже есть активный счет на оплату"),
    E007("007", "У заказа с идентификатором %s нет активного счета на оплату"),
    E008("008", "Счет с идентификатором %s для заказа с идентификатором %s уже оплачен");
